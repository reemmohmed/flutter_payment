...
class PaymentIntentModels {
	...
	factory PaymentIntentModels.fromJson(Map<String, dynamic> json) {
		return PaymentIntentModels(
			...
			amountDetails: json['amount_details'] == null
						? null
						: AmountDetails.fromJson(json['amount_details'] as Map<String, dynamic>),
